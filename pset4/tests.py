import unittest
import ast
from latencies_template import latencies, conservative_latencies
...
class TestConservativeLatencies(unittest.TestCase):
    ...
    def test_conservative_loops_advanced_2(self):
        ...
        L = lambda x, y: cost_matrix[x][y]
        student_res = conservative_latencies(N, L)
        expect_res = ast.literal_eval("[[990, 2068, 1430, 1641, 1485], [2068, 854, 1060, 849, 1573], [1430, 1060, 422, 633, 935], [1641, 849, 633, 422, 1146], [1485, 1573, 935, 1146, 990]]")
    ...
    def test_conservative_loops_advanced_3(self):
        ...
        #expect_res = ast.literal_eval("[[12, 20, 10, inf, 12], [20, 16, 14, inf, 12], [10, 14, 4, inf, 6], [inf, inf, inf, inf, inf], [12, 12, 6, inf, 4]]")
        #self.assertEqual(student_res, expect_res, "Not correct")
    ...
    def test_conservative_loops_advanced_4(self):
        ...
        #expect_res = ast.literal_eval("[[11, float('inf'), 15], [14, float('inf'), 12], [18, float('inf'), 11]]")
        #self.assertEqual(student_res, expect_res, "Not correct")
